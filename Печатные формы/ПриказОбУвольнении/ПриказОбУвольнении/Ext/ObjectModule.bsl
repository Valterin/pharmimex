...
Функция СформироватьПечатнуюФорму(СсылкаНаДокумент, ОбъектыПечати)Экспорт
	...
	Работник.Параметры.РаботаТрудовойДоговорДатаОформленияНаПечать = Формат(ТЗ[0].ДатаДоговораКонтракта,"ДФ=dd.MM.yyyy");
	Работник.Параметры.РаботаТрудовойДоговорНомер                  = ТЗ[0].НомерДоговораКонтракта;
	Работник.Параметры.РаботаДатаУвольненияНаПечать = Формат(ТЗ[0].ДатаУвольнения,"ДФ=dd.MM.yyyy");
	...
	Работник.Параметры.РаботаСтатьяТКРФНаПечать =       ТЗ[0].СтатьяТКРФ;
