...
Функция СформироватьПечатнуюФорму(СсылкаНаДокумент, ОбъектыПечати)Экспорт
	...
	Счетчик = Счетчик + 1;	
	//ТабличныйДокумент.Вывести(ШапкаТаблицы);
	Строка.Параметры.НомерСотрудника = Счетчик;
	...
	Подвал.Параметры.ПодписантКадровыхДокументов = УправлениеСвойствами.ЗначениеСвойства(СсылкаНаДокумент.Организация, ПодписантКадровыхДокументов1);
	ТабличныйДокумент.Вывести(Подвал);
	  
	Для Каждого Строка Из ТЗ Цикл
		Подписант2 = УправлениеСвойствами.ЗначениеСвойства(Строка.Подразделение, ПодписантКадровыхДокументов2);
	...
	ПодвалПодписант.Параметры.ПодписантКадровыхДокументов = УправлениеСвойствами.ЗначениеСвойства(СсылкаНаДокумент.Организация, ПодписантКадровыхДокументов3);
	ТабличныйДокумент.Вывести(ПодвалПодписант);	
    КонецЕсли;  
	//ТабличныйДокумент.ВывестиГоризонтальныйРазделительСтраниц();	
	КонецЦикла;
